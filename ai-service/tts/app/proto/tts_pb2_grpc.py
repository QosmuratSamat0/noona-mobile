...
from app.proto import tts_pb2 as tts__pb2
...
class TTSServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamSpeech = channel.unary_stream(
                '/tts.TTSService/StreamSpeech',
                request_serializer=tts__pb2.SpeechRequest.SerializeToString,
...
def add_TTSServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamSpeech': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=tts__pb2.SpeechRequest.FromString,
...
class TTSService(object):
    ...
    def StreamSpeech(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/tts.TTSService/StreamSpeech',
            tts__pb2.SpeechRequest.SerializeToString,
